...
function CMakeCodeFormater(config){
  ...
  this.func = (elt, name)=>{
    ...
    this.untab();
    this.invoke("end", [{type:"unquoted_argument", value:elt.identifier.value}]);
    if(config.BlankLinesAroundFunctions){
      if(this.newlineEmitted <= 1) this.newline();
    }
  }
...
function format(data) {
    ...
    var ast = parse(data);
    var formaterVisitor = new CMakeCodeFormater(FormatConfig);
    traversAST(ast, formaterVisitor);
    return formaterVisitor.result;
}
