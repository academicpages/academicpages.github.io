...
class SyndicationFeed:
    ...
    def add_root_elements(self, handler: ContentHandler) -> None: ...  # type: ignore [no-any-unimported]
    def item_attributes(self, item: Dict[str, Any]) -> Dict[Any, Any]: ...
    def add_item_elements(  # type: ignore [no-any-unimported]
...
class RssFeed(SyndicationFeed):
    content_type: str = ...
    def write_items(self, handler: ContentHandler) -> None: ...  # type: ignore [no-any-unimported]
    def endChannelElement(self, handler: ContentHandler) -> None: ...  # type: ignore [no-any-unimported]
