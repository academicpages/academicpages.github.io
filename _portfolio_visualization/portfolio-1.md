...
<div style="text-align: center;">
    <img src="https://github.com/jvilchesf/portfolio.github.io/blob/main/images/Workflow_diagram.png" alt="Workflow Diagram" width="200" height="200">
</div>
...
* I used Tableau to create three main visuals to analyze how rent prices have changed over the years:
    * A map visualization to filter data by each county in Ireland.  
    ...
    <img src="https://github.com/jvilchesf/portfolio.github.io/blob/main/images/portfolio_viz_1_TabeauMap.png" alt="Map" width="500" height="600">

    * A horizontal bar chart to compare the year-over-year differences in average rent prices.

    <img src="https://github.com/jvilchesf/portfolio.github.io/blob/main/images/portfolio_viz_1_TabeauHorizontalMap.png" alt="Map" width="500" height="600">

    * A text table to display detailed data for each city within each county.

    <img src="[/images/portfolio_viz_1_TabeauTextTable.png](https://github.com/jvilchesf/portfolio.github.io/blob/main/images/portfolio_viz_1_TabeauTextTable.png)" alt="Map" width="500" height="600">
