...
In week 6, we will explore making interactive visualizations using R Shiny apps. For this, we will use the book [*Mastering Shiny*](https://mastering-shiny.org/) by Hadley Wickham. The link provides free access to the book online. We will cover the following chapters:
