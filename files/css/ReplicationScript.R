...
data_fig1 <- read_csv("./dat_fig1.csv")
...
data_fig2 <- read_csv("./dat_fig2.csv")
...
data_fig3 <- read_csv("./dat_fig3.csv")
...
data_fig4 <- read_csv("./dat_fig4.csv")
...
data_fig5 <- read_csv("./dat_fig5.csv")
...
data_fig6a <- read_csv("./dat_fig6a.csv")


data_fig6b <- read_csv("./dat_fig6b.csv")
