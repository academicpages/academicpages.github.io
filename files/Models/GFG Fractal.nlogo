...
@#$#@#$#@
<experiments>
  <experiment name="FRACTAL 2" repetitions="30" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="10"/>
    <metric>count turtles</metric>
    <steppedValueSet variable="resource" first="0.1" step="0.1" last="1"/>
  </experiment>
  <experiment name="FRACTAL 4" repetitions="2" sequentialRunOrder="false" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="30"/>
    <metric>count turtles with [equilibrium = true]</metric>
    <metric>mean [strategy] of turtles</metric>
    <metric>mean [payoff] of turtles</metric>
    <metric>count turtles</metric>
    <metric>sum [resource-here] of patches</metric>
    <steppedValueSet variable="initial-players" first="5" step="5" last="50"/>
    <steppedValueSet variable="max-resource" first="0.5" step="0.5" last="2"/>
    <steppedValueSet variable="initial-strategy" first="1" step="1" last="5"/>
  </experiment>
</experiments>
@#$#@#$#@
@#$#@#$#@
