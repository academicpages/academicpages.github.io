...
* Teaught 10 students across the world online about applying computational methods (e.g., general linear model, dimensionality reduction, dynamic systems, etc.) to neuroscience research using python
