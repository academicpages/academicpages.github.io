...
# Sample Reading List
 ...
 Colvin,R. Witt,G.B., Lacey, J., Approaches to identifying stakeholders in environmental mgmt
...
# Other Information
Starting in week 9, multi-disciplinary student teams will use class time (and outside time) to further develop energy-transition case study analyses, building on prior homework assignments and guided by instructors with backgrounds in social sciences, engineering, systems sciences, and business practice. The case studies will assess vulnerability of a transition to bottlenecks, prioritize the bottlenecks, and develop strategies to relieve bottlenecks so as to accelerate the transition.