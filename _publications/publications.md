...
- <front color=#FF000>Yiming Li</front>, Peng Wang, Xiaofei Shen, Jiayuan Liu, Haonan Duan, **Chenlin Zhou**. [Autonomous Developmental Evolutionary Learning for Robotic Manipulation](https://ieeexplore.ieee.org/abstract/document/9515679). ***IEEE International Conference on Development and Learning, ICDL 2021. (Accepted)***.
