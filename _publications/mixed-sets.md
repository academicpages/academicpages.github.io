...
excerpt: "In this paper, we leverage data-driven robust optimization to model uncertainty but move beyond the classic concept of pure uncertainty sets. We propose a weighted combination of pure uncertainty sets, called mixed sets, where each weight corresponds to the significance of the pure set in the weighted combination and therefore, in the objective function. We show that the mixed sets outperform the conventional pure sets using a shortest-path problem."
date: 2019-07-20
