...
2. generating an optimal walking route containing at least one feature point based on the starting position and target position; while the user progresses along the optimal walking route, collecting the user's displacement information;
