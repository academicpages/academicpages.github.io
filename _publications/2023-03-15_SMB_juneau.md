...
across the icefield for each model. The average annual SMB of the whole period is noted next to each model in the
645 legend, units are m w.e. a-1. Regional projections of specific total mass balance from Hock et al. (2019) are displayed
