...
(for first-order methods) that  get trapped around saddle points has measure  zero and strengthens the intuition for "Strict-Saddle  Property".
Finally, we will  talk  about  the   problem  of  tensor  decomposition  which  is inherently non-convex and how it satisfies "Strict-Saddle Property".

[Master's Thesis Link](https://drive.google.com/file/d/1MAcwvvqGJCmr4VCnvE0kCFSTUB8w4mSA/view?usp=sharing), [Slides](https://drive.google.com/file/d/1X4wGdlJvXqvzu-4C4qRFSEkSxy3ZF4Bg/view?usp=sharing)
