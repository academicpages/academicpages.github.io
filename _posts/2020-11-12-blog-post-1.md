...
3. Traffic signals based on reinforcement learning are able to learn and flexibly react to different traffic situations without the need of a predefined model of the environment.[R](https://scholar.google.com/scholar?hl=zh-CN&as_sdt=0%2C5&q=Developing+adaptive+traffic+signal+control+by+actor+%E2%80%93+critic+and+direct+exploration+methods&btnG=)
4. 