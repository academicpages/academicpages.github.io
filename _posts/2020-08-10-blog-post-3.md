...
Neste post irei mostrar algumas idéias de parâmetros para melhor analisar logs no sistema Linux.

Tive o idéia de criar este post, quando comecei a ler o artigo de [JoãoVRMaia](https://blog.joaovrmaia.com/post/analisando-dados-no-terminal/), foi quando então decidi não terminar de ler e criar um próprio para aprender ainda mais :)
