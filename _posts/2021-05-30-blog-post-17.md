...
15. A decentralized framework for simultaneous calibration, localization
and mapping with multiple LiDARs

统一的状态，多机执行各自的EKF, 通过网络进行状态通信

16. A General Framework for Lifelong Localization and Mapping in Changing Environment
