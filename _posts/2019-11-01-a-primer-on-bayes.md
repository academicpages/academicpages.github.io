...
You probably already know what Bayes theorem is or stumble upon Naive Bayes when comparing machine learning models. Maybe, like me, you feel that you barely saw the shores of the continent that is the Bayesian land and want to set foot in it.  

I wrote this article from a Stanford course with the intent to understand the relationships between all Bayesian concepts without having to go through an entire classroom (like I did).
...
I hope this guide has been helpful for you, in the [next article](https://vincent-maladiere.github.io/posts/2019/11/empirical-bayes-and-shrinkage/) we will see why high-dimension is so much fun. 
