...
<div>
  ...
  &= \frac{\mathbb{E}\left[\mathbb{E}\left[-y^2\mid \hat{\theta}\right]\right]-\mathbb{E}\left[\mathbb{E}\left[-y^2\mid \theta\right]\right]}{\mathbb{E}\left[\mathbb{E}\left[-y^2\mid \theta\right]\right]} \quad \text{ con } \hat{\theta}\sim\mathcal{N}\left( \frac{n\,\overline{y}}{\tau+n}, \frac{\sigma^2}{\tau+n} \right) \\[3ex]
