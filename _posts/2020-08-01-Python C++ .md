...
NumPy arrays may be accessed through the buffer protocal.  See more examples in the pybind11 docs [here](https://pybind11.readthedocs.io/en/stable/advanced/pycpp/numpy.html).
