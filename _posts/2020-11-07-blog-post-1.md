...
### Some classic solutions (More than 100 references)
...
4. [Paper4](https://www.sciencedirect.com/science/article/pii/S1471405105000030)
    * **Strategy**:
        * Determine holding control for all buses.
    * **Objective**:
        * Minimize the waiting time as the formula of headway. Each bus consider its impact on N downstream sops (i.e., Rolling Horizon)
