...
3. Due to high demand, most bus services operate at high frequencies, with headways typically within 10 min along major corridors. With such short headway, operators typically provide only rough headway information, e.g. headway: 5–7 min, but not the exact service timetables. Therefore,
