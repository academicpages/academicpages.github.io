...
|[Personalized Federated Learning with First Order Model Optimization](https://openreview.net/forum?id=ehJqJQk9cw)|no global model. personalize via interaction with other clients.|