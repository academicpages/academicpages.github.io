...
```
    ...
    ERROR (aesara.graph.opt): Optimization failure due to: Elemwise{sub,no_inplace}(z, Elemwise{mul,no_inplace}(alpha subject to <function <lambda> at 0x7f5e61173c10>, SparseDot(x, y))) -> Usmm{no_inplace}(Elemwise{neg,no_inplace}(alpha), x, y, z)
    ERROR (aesara.graph.opt): node: Elemwise{sub,no_inplace}(Elemwise{mul,no_inplace}.0, Elemwise{mul,no_inplace}.0)
    ERROR (aesara.graph.opt): TRACEBACK:
    ERROR (aesara.graph.opt): Traceback (most recent call last):
      File "/home/cades/anaconda3/envs/gbi_env/lib/python3.8/site-packages/aesara/graph/opt.py", line 2058, in process_node
        fgraph.replace_all_validate_remove(repl_pairs, reason=lopt, remove=remove)
      File "/home/cades/anaconda3/envs/gbi_env/lib/python3.8/site-packages/aesara/graph/toolbox.py", line 642, in replace_all_validate_remove
        chk = fgraph.replace_all_validate(replacements, reason=reason, **kwargs)
      File "/home/cades/anaconda3/envs/gbi_env/lib/python3.8/site-packages/aesara/graph/toolbox.py", line 574, in replace_all_validate
        fgraph.replace(r, new_r, reason=reason, verbose=False, **kwargs)
      File "/home/cades/anaconda3/envs/gbi_env/lib/python3.8/site-packages/aesara/graph/fg.py", line 490, in replace
        new_var = var.type.filter_variable(new_var, allow_convert=True)
      File "/home/cades/anaconda3/envs/gbi_env/lib/python3.8/site-packages/aesara/tensor/type.py", line 258, in filter_variable
        raise TypeError(
    TypeError: Cannot convert Type TensorType(float64, matrix) (of Variable Usmm{no_inplace}.0) into Type TensorType(float64, row). You can try to manually convert Usmm{no_inplace}.0 into a TensorType(float64, row).
    
    <ipython-input-13-0f34c7650a8b>:18: FutureWarning: In v4.0, pm.sample will return an `arviz.InferenceData` object instead of a `MultiTrace` by default. You can pass return_inferencedata=True or return_inferencedata=False to be safe and silence this warning.
      trace = pm.sample(target_accept=0.95, tune=2000)
    ...
    /home/cades/anaconda3/envs/gbi_env/lib/python3.8/site-packages/aesara/graph/fg.py:500: UserWarning: Variable Elemwise{add,no_inplace}.0 cannot be replaced; it isn't in the FunctionGraph
      warnings.warn(
    <<!! BUG IN FGRAPH.REPLACE OR A LISTENER !!>> <class 'TypeError'> Cannot convert Type TensorType(float64, matrix) (of Variable Usmm{no_inplace}.0) into Type TensorType(float64, row). You can try to manually convert Usmm{no_inplace}.0 into a TensorType(float64, row). Elemwise{sub,no_inplace}(z, Elemwise{mul,no_inplace}(alpha subject to <function <lambda> at 0x7f5e61173c10>, SparseDot(x, y))) -> Usmm{no_inplace}(Elemwise{neg,no_inplace}(alpha), x, y, z)
    ERROR (aesara.graph.opt): Optimization failure due to: Elemwise{sub,no_inplace}(z, Elemwise{mul,no_inplace}(alpha subject to <function <lambda> at 0x7f5e61173c10>, SparseDot(x, y))) -> Usmm{no_inplace}(Elemwise{neg,no_inplace}(alpha), x, y, z)
    ERROR (aesara.graph.opt): node: Elemwise{sub,no_inplace}(Elemwise{mul,no_inplace}.0, Elemwise{mul,no_inplace}.0)
