...
Refer to [Ubuntu 18.04 (CUDA 10.1)](https://www.tensorflow.org/install/gpu#ubuntu_1804_cuda_101)
...
#### 5. Link libraries to standard locations
...
#### 6. Add these lines to end of `~/.bashrc`:   
