...
What would an exact $$1 - 𝛼$$ confidence interval look like for $$\theta$$ for $$N$$ coin tosses? We use the CDF of the binomial distribution to build a *Clopper-Pearson* interval, see [\[3\]](#frequentist-interval-estimation). However this approach is too heavy in computation.
...
where $$I(\theta)$$ is the Fisher information matrix. In [\[8\]](#objective-priors) we show that this prior is actually the $$Beta(1/2, 1/2)$$ prior.
...
this.page.url = "https://vincent-maladiere.github.io/posts/2019/10/a-primer-on-bayes/";  // Replace PAGE_URL with your page's canonical URL variable
this.page.identifier = "a-prior-on-bayes"; // Replace PAGE_IDENTIFIER with your page's unique identifier variable
};

(function() { // DON'T EDIT BELOW THIS LINE
var d = document, s = d.createElement('script');
s.src = 'https://vincent-maladiere.disqus.com/embed.js';
