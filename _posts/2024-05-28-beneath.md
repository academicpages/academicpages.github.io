...
<div style="text-align: right;">
  ...
  <em>Originally published in English on <a href="https://twitter.com/ArduinoTomasi/status/1791956012926185797">X Articles</a></em>
  
  <a href="#" onclick="translateLanguage('es')">Español</a> | 
  <a href="#" onclick="translateLanguage('fr')">Français</a> | 
  <a href="#" onclick="showTranslateDropdown()">Other</a>
