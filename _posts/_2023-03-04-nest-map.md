---
title: Large-Language Models Applied to Immune Repertoire Analysis
output:
  md_document:
...
date: 2023-12-15
permalink: /posts/2023/12/llm-ir
excerpt_separator: <!--more-->
always_allow_html: true
toc: true
header:
 og_image: "posts/llm_ir/llm_ir-380.png"
tags:
  - llm
  - data-science
  - visualization
...
Large language models are everywhere, I wanted to see if they could be useful for analyzing antibody sequences. 
...
mods_var %>% 
  ...
  scale_color_manual(name = 'Statistical significance',
                     labels = str_to_title,
![png](/images/posts/llm_antibody/ll
                     values = park_palette('Saguaro')) +
