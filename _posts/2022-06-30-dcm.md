...
* [1. Introduction to Causal Inference](https://github.com/Angela-Coapaza/Causal_Inference_and_Machine_Learning/tree/main/1.%20Introduction%20to%20Causal%20Inference)
  ...
  In this section, we analyze the pay gap between women and men using the U.S. Current Population Survey (2015) and job-relevant characteristics, especially in the subset of college-educated workers. Our results indicate that women earn 8.15% less than men, despite the fact that women have an average experience of 12 years.
