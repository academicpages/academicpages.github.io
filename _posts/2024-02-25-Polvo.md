...
<br>Para robustecer el análisis, es viable realizar un test de placebo mediante la asignación aleatoria de un tratamiento ficticio a cada observación. Este procedimiento es clave para verificar la resistencia de los hallazgos ante potenciales sesgos, puesto que con tal asignación aleatoria no esperaríamos identificar efectos significativos del tratamiento. La aparición de diferencias estadísticamente relevantes bajo estas condiciones sugeriría la existencia de sesgos o variables de confusión no consideradas en el modelo central. Así, este método refuerza la validez de las inferencias al eliminar la posibilidad de resultados espurios. Al mismo tiempo, aumenta la confianza en la relación causal estimada a partir de los efectos de la clausura de la Base de Manta en 2009. Aplicando el comando de R que se presenta en la siguiente sección, observamos que nuestro modelo inicial pasa satisfactoriamente la prueba de placebo:<br>
