...
<pre style="background-color: #f4f4f4; color: #333; padding: 20px; border-radius: 0px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); font-family: 'Courier New', Courier, monospace; line-height: 1.5; overflow-x: auto; font-size: 12px;max-width: 450px;">
<code>
