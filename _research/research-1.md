---
title: "Perception-based seam cutting"
excerpt: "Research on the second step of image stitching: seam-cutting <br/><img src='/images/seam-cutting.jpg'>"
collection: research
---

# Perception-based seam cutting for image stitching
Nan Li,  [Tianli Liao](https://tlliao.github.io)  and Chao Wang
...
* [Perception-based-seam-cutting](https://github.com/tlliao/Perception-based-seam-cutting)        
  Given two input images, stitch them together into a seamless result.  


### Dataset

We experimented with our algorithm on images from the [Parallax](http://web.cecs.pdx.edu/~fliu/project/stitch/) and [SEAGULL](http://www.linkaimo.com/publications/ImageStitching/ImageStitching.html) datasets and our own stitching dataset. You can download the stitching [dataset](https://tlliao.github.io/images/dataset.zip) here.
