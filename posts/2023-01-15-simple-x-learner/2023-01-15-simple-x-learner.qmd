...
description: "A guide to the simplified X-learner approach for Uplift modeling"
image: "uplift.webp"
tags:
  - causal_inference
  - machine_learning
...
![S-learner treatment effect distribution](x-learner-s.webp)
...
![T-learner treatment effect distribution](x-learner-t.webp)
...
![Xs-learner treatment effect distribution](x-learner-xs.webp)
...
![X-learner treatment effect distribution](x-learner-x.webp)
