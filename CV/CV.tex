...
\begin{pSubsection}{NASA ROSES Biodiversity: }{Mapping changes in forest diversity and disease in North American temperate forests.}{}{Role: Co-Investigator}{I wrote parts of and edited sections on 1) species distribution models, 2) classification and mapping lineages using phylogenetic approaches, and 3) community composition predictions derived from remote sensing satellite imagery. Cavender-Bares, Jeannine (Lead-PI, UMN), Townsend, Philip (co-PI, UW).}
\end{pSubsection}
...
\begin{pSubsection}{National Science Foundation, BII Implementation: }{The causes and consequences of plant biodiversity across scales in a rapidly changing world.}{2020-2025}{Role: Co-Investigator}{I wrote parts of and edited sections on 1) Macroevolutionary modeling of plant spectra and other relevant functional traits and 2) estimation of diversity and function at the landscape scale. More information following the link: \url{https://www.spectralbiology.org}. Cavender-Bares, Jeannine (Lead-PI, UMN), Townsend, Philip (co-PI, UW), Reich, Peter (co-PI, UMN), José E. Meireles (co-PI, UMaine), Amy Trowbridge (co-PI, UW). Award: USD 12,5000,000.}
\end{pSubsection}
...
As of January 2021, I have published 18 peer-reviewed articles in indexed journals, 11 peer-reviewed in non-indexed journal, 4 peer-reviewed book chapters and 3 non-peer-reviewed chapters.
...
\begin{rSection}{Intelectual Contributions in Preparation:}
...
\begin{sSubsection}{Invited talk - Plant diversity: community structure, compostion and detection}{ }{Jan, 2021}{ Ecology, Evolution and Behavior Seminar Series, University of Minnesota}{St Paul, MN}
\end{sSubsection}

\begin{sSubsection}{Invited talk - Macroecology and macroevolution in the Neotropics}{ }{Nov, 2020}{Department of Goegraphy, Federal University of Rio Grande do Norte}{Natal/RN, Brazil}
\end{sSubsection}
...
Computer Programing & Advanced: R, Markdown \\
...
Ecology(3), Frontiers in Ecology and the Environment, Ecological Monographs(2), Ecology Letters, Journal of Biogeography(8), Global Ecology and Biogeography(3), Diversity and Distributions(3), Ecology and Evolution(2), Journal of Field Ornithology, EMU (Australian Journal of Ornithology), El Hornero (Ornitología Neotropical), Kempffiana, Oecología Australis, Journal of Aninal Ecology(2), Journal of Plant Ecology, Annals of Botany, Biodiversity and Conservation(2), Forest Ecology and Management, Plos One, Prespectives in Ecology and Conservation(2), Journal of Zoological Systematics and Evolutionary Research, Nature Communications, Systematic Biology, Biological Journal of the Linnean Society, The American Naturalist, Journal of Vegetation Science. 
