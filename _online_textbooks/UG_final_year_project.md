...
This is only for QMUL's final year undergraduate students mostly (but not always) part of the
Aerospace Engineering cohort for the
[EMS690U final year project](https://qmplus.qmul.ac.uk/course/view.php?id=22090) under my supervision.
It will make little to no sense for anyone else (inlcuding those from QMUL).
...
1. **Presentation**: elevator pitch style in the early weeks to eventually being able to give rapid updates
in the later weeks.
