...
!!! img
This is what'scalled a directory listing - contents of folder I'm in. So I'm in my codespace's default folder. This web page is specific to the codespaces. I am running my own web server at this weird looking URL that github dynamically generated for me.
```console
