...
Over the past few years, I have been working on development of this couplde model. [FIO-AOW](https://github.com/Biao-Zhao/FIO-AOW) consists of atmoshpher component (WRF)，ocean surface wave component (MASNUM) and ocean circulation component (POM&ROMS). All the components are coupled together through C-Coupler. It should be noted that all the components are open source except MASNUM, [WRF](https://github.com/wrf-model/WRF), [ROMS](https://github.com/kshedstrom/roms), [C-Coupler](https://github.com/C-Coupler-Group/c-coupler-lib), and [POM](http://www.ccpo.odu.edu/POMWEB/). In FIO-AOW, the POM and MASNUM were speeded up through MPI technique by Wang et al. (2010). For more details about FIO-AOW, people could refer to the papers below
