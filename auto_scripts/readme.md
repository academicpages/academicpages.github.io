This website and my [CV](samsledje.github.io/cv) build themselves with [PyYAML](https://pyyaml.org/) and [Jekyll](https://jekyllrb.com/). The following scripts are used to generate Jekyll markdown from YAML files:
