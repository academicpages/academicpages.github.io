...
| 기관명                | 소프트웨어 저작명                                                                      | 번호            | 비고  |
|:---------------------:|:--------------------------------------------------------------------------------------:|:---------------:|:------:|
| 조선대학교 산학협력단  | 무선 LAN 네트워크에서의 IEEE 802.11n WiFi 및 CSI 검출을 위한 Frimware 명령어 기반 Embedded SW 프로그램 |   | 신청  |
| 조선대학교 산학협력단  | 무선 채널 및 RF 응답 측정을 위한 Software-Defined Radio (SDR) 기반 2X2 MIMO-OFDM 테스트베드 프로그램   |   | 신청  |
...
| 기관명                  | 특허명                                                                                     | 번호                 | 법적상태            |
|:-----------------------:|:-------------------------------------------------------------------------------------------:|:---------------------:|:------------------:|
| 조선대학교 산학협력단    | 다중목표 강화학습 기반 전력 전송 할당 기법을 통한 Massive MIMO(multi-input multi-output) network의 효율을 최적화하는 기지국|10-2023-0192682      | 출원 (2023-12-27)  |
| 조선대학교 산학협력단    | 다중 홉 릴레이 네트워크에서 데이터 패킷 전송 경로를 제어하는 장치 및 방법                       | 10-2517805-0000      | 등록 (2023-03-30)  |
| 인트플로우 (주)         | 축산귀표인식장치, 및 그 장치가 탑재되는 스마트시스템                                           | 10-2023-0045496      | 공개 (2023-04-04)  |