...
<ul>
  <li>Contractivity of Continuous-Time Neural Networks</li>
</ul>
...
<ul>
  <li>Well-posedness of DEQs and Lipschitz Constants</li>
  <li>Training of Robust DEQs<\li>
  <li>Verification of DEQs using Mixed Monotonicity<\li>
</ul>
...
<ul>
  <li>Non-Euclidean Contraction Theory</li>
  <li>Non-Euclidean Contraction for Monotone and Positive Systems<\li>
  <li>From Contraction to Fixed-Point Algorithms<\li>
</ul> 
...
<ul>
  <li>Non-Euclidean Monotone Operator Theory</li>
</ul>
...
<ul>
  <li>Sparsity Structure and Sufficient Condition for Optimality</li>
  <li>Equivalence to Leader-Follower Consensus<\li>
  <li>Low-Mobility Atmospheric Sensing<\li>
</ul> 
