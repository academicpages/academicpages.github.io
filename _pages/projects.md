...
| 기관명                | 소프트웨어 저작명                                                                          | 번호            | 비고  |
|:---------------------:|:----------------------------------------------------------------------------------------:|:---------------:|:------:|
| 조선대학교 산학협력단  | 무선 LAN 네트워크에서 IEEE 802.11n WiFi 및 CSI 검출을 위한 펌웨어 명령어 기반 Toolkit 프로그램 | C-2024-xxxxxx | 승인대기  |
| 조선대학교 산학협력단  | 무선 채널 및 RF 응답 측정을 위한 Software-Defined Radio (SDR) 기반 2X2 MIMO-OFDM 테스트베드 프로그램   | C-2024-xxxxxx | 승인대기  |
