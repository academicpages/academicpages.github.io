...
* **축산오염환경에 강건한 동물 활동 모니터링을 위한 RF 기반 영상정보 보완기술 기초연구 (중소기업기술정보진흥원, 2023.05.01 - 2024.02.29, 4%)**
  * 수행 역할
...
* **Flying Ad-Hoc Network를 위한 연합 심층강화학습 기반 자원할당 기술 연구 (한국연구재단, 2021.10.01 - 2024.02.29, 58%)**
  * 수행 역할
...
* **전이중 클라우드 무선 접속 네트워크를 위한 딥러닝 기반 빔형성 프로토콜 개발 (한국연구재단, 2021.03.01 - 2022.02.28, 20%)**
  * 수행 역할
...
* **BWMS 데이터 전송을 위한 무선 통신 기술 개발 (해양수산과학기술진흥원, 2020.04.01 - 2020.12.31, 60%)**
  * 수행 역할
