...
| Institution        | Research project                                                                       | Participation period    | Participation rate |
|:------------------:|:-------------------------------------------------------------------------------------- |:-----------------------:|:------------------:|
| Encored P&P (Inc.) | [개발도상국 내 전력 선불 거래를 위한 전용 애플리케이션 설계 및 개발](#)                      | 2020.08.01 - 2020.09.31 | 100                |
| Intflow (Inc.)     | [딥러닝 기반 비접촉식 발열 측정 시스템 설계 및 개발](#)                                    | 2020.11.01 - 2021.01.30 | 100                |
| Intflow (Inc.)     | [축사 내 축산 위치 추적을 위한 IoT 기반 실시간 위치 추정 시스템 설계 및 개발](#)             | 2021.04.01 - 2022.09.28 | 100                |
| KAIST (Univ.)      | [의학-ICT 융합 헬스케어 기반 전용 애플리케이션 설계 및 개발](#)                             | 2021.08.01 - 2022.10.10 | 100                |
...
|:------------------:|:-------------------------------------------------------------------------------------- |:-----------------------:|:------------------:|
| Chosun (Univ.)     | [사물인터넷(IoT) 멀티 센서 기반의 공유 서비스 프로그램](#)                                  | C-2022-008305           | 100                |
| Chosun (Univ.)     | [BWMS 데이터전송을 위한 멀티 홉 릴레이 네트워크 테스트베드 프로그램](#)                      | C-2022-001887           | 100                |
| Chosun (Univ.)     | [다중 홉 릴레이 네트워크 테스트베드 프로그램](#)                                           | C-2020-031710           | 100                |
...
| Chosun (Univ.)     | [다중 홉 릴레이 네트워크에서 데이터 패킷 전송 경로를 제어하는 장치 및 방법](#)                | 10-2021-0060683         | 100                |