...
**Everyone, every week**: After each class session, *by 9 pm on the same day*, post your thoughts on Piazza, for example, which parts did you enjoy reading,
 ...
 <span style="color:MediumRed">**Important: Your post should start with the phrase "Weekly assignment: "** (assignment completion checks will be done in an automatic manner).</span>
