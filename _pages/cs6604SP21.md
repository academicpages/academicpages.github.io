...
for example, remove roles or make roles optional in case enrollment decreases or allow groups of two students for all roles in the event of enrollment increase.*
 ...
 Convince your industry boss that it's worth investing time and money to implement this paper. Your arguments should be particularly applicable to the chosen industry market.
  - **Hacker:** Implement a small part of the paper on a small dataset or toy problem, or any other simplified version of the paper. Share a Jupyter Notebook with the code of the algorithm with the class. Please do not simply download and run an existing implementation, make an effort to at least implement a core method from the paper. 
...
Thursday, 01/21/2021 |  Active Learning overview (presented by Ismini) |
Tuesday, 01/26/2021 |   Semi-supervised: Option 1) [Pseudo-Label : The Simple and Efficient Semi-Supervised Learning Method for Deep Neural Networks](http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.664.3543&rep=rep1&type=pdf)  Option 2) [MixMatch: A Holistic Approach toSemi-Supervised Learning](https://arxiv.org/pdf/1905.02249.pdf) Option 3) [FixMatch: Simplifying Semi-Supervised Learning with Consistency and Confidence](https://arxiv.org/ftp/arxiv/papers/2001/2001.07685.pdf) Option 4) [Semi-Supervised Sequence Modeling with Cross-View Training](https://arxiv.org/pdf/1809.08370.pdf)|
Thursday, 01/28/2021 | Active Learning: Option 1) [Learning How to Active Learn by Dreaming](https://www.aclweb.org/anthology/P19-1401.pdf) Option 2) [BatchBALD: Efficient and Diverse Batch Acquisitionfor Deep Bayesian Active Learning](https://arxiv.org/pdf/1906.08158.pdf) Option 3) [Proactive Learning: Cost-Sensitive Active Learning withMultiple Imperfect Oracles](http://www.cs.cmu.edu/afs/cs/Web/People/jgc/publication/PublicationPDF/Proactive_Learning_Cost-Sensitive_Active_Learning_With_Multiple_Imperfect_Oracles.pdf) Option 4) [Asking the Right Questions to the Right Users: Active Learning with Imperfect Oracles](https://ojs.aaai.org//index.php/AAAI/article/view/5738)  |
Tuesday, 02/02/2021 |    |
Thursday, 02/04/2021 |    |
Tuesday, 02/09/2021 |    |
Thursday, 02/11/2021 |    |
