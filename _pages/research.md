...
The efficient allocation of labor relies on the identification of talent. When employee output is not publicly observable, however, employers have incentives to take advantage of private information rents, potentially leading to the misallocation of workers between firms. This paper provides empirical evidence of employer learning and quantifies the impact of learning on job mobility and innovation outputs in the labor market for Ph.D.'s in computer science (CS). Papers in CS conference proceedings offer a rare chance to observe research effort by both academic and non-academic CS workers. About one-quarter of CS papers from industry can be matched to patent applications filed around the same time – a choice that indicates a more valuable innovation. Yet the fact of a patent application remains private information to the incumbent employer for more than a year. CS researchers with a new paper are 13-26% more mobile across firms than similar coworkers without a paper. Initially, authors of papers with a matched patent are less likely to move than authors of papers with no patent application. Once the application is publicly revealed, however, the authors are 20-35% more likely to move into a top firm than coworkers without such signals. The findings confirm the predictions of a model of a dynamic game between employers who learn a worker's ability from her innovation outputs and where the incumbent employer has an initial information advantage. Structural estimates of the model suggest that if matched patents and papers were disclosed simultaneously, then higher-ability workers would switch firms more frequently and move to more productive firms. Total innovation outputs would increase by 3-5%, and talent revelation during the first five years of work experience would increase by 5%.   </div>
