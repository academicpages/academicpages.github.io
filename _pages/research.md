...
- **Reveal or Conceal? Employer Learning in the Labor Market for Computer Scientists**  <br/>
<a href="#/" onclick="visib('jmp')">Abstract</a> \| <a href="/files/AliceWu_JMP.pdf" target="_blank">Paper</a>
...
- **Who Becomes an Inventor? The Role of Firms in Talent Discovery**. (with <a href="https://scholar.google.com/citations?user=IgkUsgIAAAAJ&hl=en" target="_blank">Sabrina Di Addario</a>) <br/> <a href="#/" onclick="visib('italy')">Abstract</a> \| *Draft Coming Soon*
<div id='italy' style="display: none; text-align: justify; line-height: 1.2" >
This paper investigates the role of firms in discovering new inventors who apply for a patent for the first time. Using employer-employee data from the Italian Social Security Institute matched with patent applications between 1987 and 2009, we keep track of the employment and innovation history of more than one hundred thousand *potential* inventors, who either produced a patent application assigned to their employers during the sample period or are estimated to have a high probability of ever inventing based on observable characteristics. There is large heterogeneity in the discovery of new inventors across firms, particularly for workers early in their careers. Ranking firms by mean wages, we find that potential inventors younger than 35 are 45% less likely to become an inventor at firms in the bottom quartile than similar workers in the top quartile, conditional on industry and geographic heterogeneity. Younger workers who do invent at the bottom quartile firms on average experience an 8 log-point wage increase, rather than 3 log points at the top quartile. The gaps between firms in talent discovery and wage returns to patents are smaller in magnitude among older workers, for whom employer learning is more complete. Established inventors who have applied for patents before, in contrast with younger workers who have not, are more likely to continue patenting at lower-wage firms. We provide a two-period model of employer learning that accounts for the dynamic concerns of firms and workers to explain these findings.  </div>
...
- **Gender Bias in Rumors Among Professionals: An Identity-based Interpretation**. Review of Economics and Statistics, 102, 5, pp. 867-880. December 2020. <br/>
<a href="#/" onclick="visib('ejr')">Abstract</a> \| <a href="/files/wu_ejr_restat.pdf" target="_blank">Paper</a> \| <a href="https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/BLEBHI" target="_blank">Replication</a> 
...
- **Gendered Language on the Economics Job Market Rumors Forum** AEA Papers and Proceedings, 108, pp. 175-179. May 2018.  <br/>
