...
<table style="border: 2px solid black; border-collapse: collapse; width: 100%;">
    ...
    <tbody>
        ...
        <tr style="height: 29px;">
            ...
            <td style="height: 29px; width: 60%;">
                Benchmarks: Simulators, Environments, Datasets <br>
        ...
        <tr style="height: 29px;">
            ...
            <td style="height: 29px; width: 60%;">
                Conceptual Framing, World Models, Behavioral and Performance Metrics <br>
        ...
        <tr style="height: 29px;">
            ...
            <td style="height: 29px; width: 60%;"><span style="color: #000000;">Conceptual Framing, World Models, Behavioral and Performance Metrics <br> <a class="inline_disabled" href="https://arxiv.org/abs/2105.00931" target="_blank" rel="noopener">GRIDTOPIX: Training Embodied Agents with Minimal Supervision</a></span><strong><span style="color: #169179;"><span style="color: #b96ad9;">&nbsp; </span><br /></span></strong></td>
        </tr>
        <tr style="height: 29px;">
        ...
        <tr style="height: 29px;">
            ...
            <td style="height: 29px; width: 60%;">
                <span style="color: #000000;">Learning about language and language-guided interaction&nbsp;</span> <br>
        ...
        <tr style="height: 29px;">
            ...
            <td style="height: 29px; width: 60%;">
                Learning about language and language-guided interaction <br>
        ...
        <tr style="height: 29px;">
            ...
            <td style="height: 29px; width: 60%;">
                Robot Learning, Sim2Real Transfer, Multi-agent Systems, Emergent Communication <br>
