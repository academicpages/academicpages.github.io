...
- Our [Hyperspectral Aerial Video Set](https://buzkent86.github.io/datasets/) for vehicle tracking is uploaded. Please cite the paper listed below if you use this dataset in your research. Our dataset also contains the ground truth files of the vehicles in the scene. You can download the MATLAB code with C-based detection module in this [link](https://github.com/buzkent86/CVPRW17_Paper_Code).
