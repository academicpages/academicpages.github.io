...
During my undergraduate studies, I have worked on **machine learning**, **data science**, **convex optimization**, and **signal processing**. Specifically, my work involves designing cutting-edge algorithms for time series, spatiotemporal prediction, and convex optimization in high-dimensional spaces. I have first authored a recently submitted journal [paper](https://doi.org/10.48550/ARXIV.2310.17544) to the Journal of Machine Learning.
