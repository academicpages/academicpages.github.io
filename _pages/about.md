...
I am a PhD candidate at NYU advised by Professor [Andrew Gordon Wilson](https://cims.nyu.edu/~andrewgw/). I work on the foundations of deep learning and focus on understanding the generalization properties of deep neural networks using notions that relate to generalization such as the marginal likelihood, PAC-Bayes bounds and model compression. Inspired by findings about generalization, I aim to build more robust and reliable machine learning models. 
