...
* Senior Linux System Administrator - Retail DevOps & Hardware
  ...
  - Responsible for deploying and running mission-critical Linux servers in
...
* Senior Linux System Administrator - Retail DevOps & Hardware
  ...
  - Responsible for maintaining live production systems
  - Responsible for deploying and running mission-critical Linux servers in
    virtualized environments, on-prem or on the Azure cloud, using vSphere
    and Kubernetes (Tanzu)
  - Software development using best practices of
    the full software development life cycle, including coding standards,
    code reviews, source control, testing, build and release engineering
    processes with focus on automation and end to end traceability.
...
* Languages I am Excited to Learn
  * Rust
* Frameworks and Libraries I am Eager to Learn
  * React, TailwindCSS, Starlite (Akin to FastAPI), Gradle, Maven
* Tools
  * Git, Linux, Docker, AWS/GCP/Azure, Jira, Active Directory, Group Policy, VMWare vSphere, LXD/LXC
* Tools I am Excited to Learn
  * CI/CD (Jenkins, TravisCI), Kubernetes, Container Orchestration
