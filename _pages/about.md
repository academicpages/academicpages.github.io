...
<div class="profile-info">
  I am on the <strong>2024-25 Academic Job Market</strong>. <a href="https://economics.mit.edu/sites/default/files/2024-10/CV_jmp_houeix_1.pdf">[Click here to download my CV]</a> - <a href="mailto:houeix@mit.edu">houeix@mit.edu</a>
</div>
...
1. <a href="https://drive.google.com/file/d/1xPuviUJ2E1m4keNPSSiSYVsBQd7-caCq/view?usp=sharing">Asymmetric Information and Digital Technology Adoption: Evidence from Senegal</a> **(Job Market Paper)**, _Media Coverage_: <a href="https://www.rfi.fr/fr/podcasts/afrique-économie/20230222-à-dakar-le-paiement-mobile-facilite-les-transactions-et-améliore-les-revenus-des-taxis">RFI</a>
   <details>
        ...
        <div class="abstract-content">
            <p>Digital technologies have the potential to enhance firm productivity. However, by increasing data observability and reducing information frictions, they may also reshape contracts as a byproduct—and this can be a double-edged sword. Agents may lose their informational rent and thus resist adoption.  I explore this trade-off through two field experiments—guided by contract theory—where I introduce digital payments to the Senegalese taxi industry in partnership with the country's largest payment company. In the first experiment, I randomize access to digital payments for drivers (employees) and, within this group, further randomize transaction observability to taxi owners (employers). I find that digital payments reduce drivers' cash-handling costs by about half but also serve as effective monitoring tools for taxi owners. Transaction observability substantially increases driver effort, leads to efficient contract changes, and extends the duration of owner-driver relationships. However, 50% of drivers—primarily the worst-performing and poorest—decline to adopt digital payments when transactions are observable. The second experiment shows that the adoption rate doubles when drivers are assured that owners cannot observe their transactions. I develop a theoretical framework and use the experimental variations to estimate the welfare impacts of policy counterfactuals. I show that mandating technology adoption can reduce welfare relative to the status quo, while removing transaction observability broadens adoption but maintains moral hazard problems. These findings highlight the crucial role of information embedded in digital technologies, with important implications for firm growth and technology adoption.</p>
        </div>
    </details>
