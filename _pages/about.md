...
My current research focuses on anomaly detection and zero-shot learning, self-supervised learning, domain adaptation, and other topics relevant to medical imaging; see my [Google Scholar page](https://scholar.google.com/citations?user=a9rXidMAAAAJ&hl=en) for a list of my publications.
...
Teaching is also important to me, and I have been an educator [in the academic setting](https://nickk124.github.io/teaching/) and [beyond](https://nickk124.github.io/outreach/). I have also worked on many [side projects](https://nickk124.github.io/projects/) that have captured my interest. 

<!-- See [here](https://nickk124.github.io/cv/) for my updated CV. -->
