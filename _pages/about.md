...
# Recent News
* Jan. 9, 2023, Our paper <b>Deep learning-based accurate and robust delineation of primary gross tumor volumes of nasopharyngeal carcinoma on heterogeneous magnetic resonance imaging: a large-scale and multi-center study</b> was accepted by <b>Radiation and Oncology</b> (also named as "GreenJournal", top-tier journal in the radiation and oncology field), thanks to all co-authors, [code]([https://github.com/Luoxd1996/RobustNPC]) and [paper](https://luoxd1996.github.io/publications/) are available.
