...
<img decoding="async" src="/images/polyu_logo.png" width="10%" style="float:left;" /><span style="float:left">文1</span>字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字</div>
