...
<div class="profile-container">
  ...
  <div class="profile-text">
    ...
    <p>My dissertation explores how digital technologies reshape economic relationships and contract structures within and between firms, while uncovering the key drivers and barriers to their adoption.</p>    
    <p>Over the past eight years, I have conducted research projects in Côte d'Ivoire, Ethiopia, Senegal, and Togo. </p>
  </div>
</div>

<div class="profile-info">
  I am on the <strong>2024-25 Academic Job Market</strong>. <a href="https://houeix.github.io/files/DeivyHoueix_CV.pdf">[CV]</a> - <a href="mailto:houeix@mit.edu">houeix@mit.edu</a>
</div>
...
1. Asymmetric Information and Digital Technology Adoption: Evidence from Senegal **(Job Market Paper)**, *Draft Coming Soon*
   <details>
        ...
        <div class="abstract-content">
            <p>I combine two field experiments and a contract theory model to study how digital technologies can alleviate information asymmetry and reshape contracts within firms, and whether these effects can explain disparities in their adoption. By making data observable to employers, these technologies may not be adopted by employees wary of losing informational rent. I explore this trade-off through the expansion of digital payments in the Senegalese informal taxi industry. In the first experiment, I randomized access to digital payment technology for taxi drivers and within this group, further randomized the degree to which transactions are observable by employers in a panel of 613 owner-driver relationships. I find that digital payments benefit drivers and serve as effective monitoring tools for taxi owners. Enhanced transaction observability increases worker effort, shifts contracts from rental toward salaried contracts, and reduces turnover. However, the introduction of the technology leads to a separating equilibrium among workers: 50% of drivers, primarily the least productive and poorest, refused to adopt it when observability was an option. The second experiment reveals that assuring these drivers that digital transactions would remain undisclosed to owners nearly doubles adoption rates. I use these experimental variations to estimate the model and perform counterfactuals. I find that mandating technology adoption would significantly increase overall welfare, but it would harm employees. These findings highlight the trade-off between transparency and adoption of digital technologies, stressing the need for policymakers and innovators to consider their distributional impacts to broaden adoption and enhance small firm growth.</p>
        </div>
    </details>
