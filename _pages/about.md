...
As a computational materials scientist, I specialize in big data research. I use synchrotron x-ray imaging technique at the [Advanced Photon Source](https://www.aps.anl.gov/) to visualize laser-matter interaction in situ and in real time. By running this advanced high-speed, in-situ observation experiments, a huge amount of 2D image data are generated. I then apply statistical tools and machine learning methods to analyze the data and predict essential properties. For example, I am developing deep learning approaches to predict laser absorption using x-ray keyhole images, creating a new pathway for process-control and a real-time monitoring system of laser-based additive manufacturing. 
