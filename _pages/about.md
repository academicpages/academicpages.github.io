...
My long-term interests are to use genetic variation for (1) therapeutic target discovery, by discovering new genetic associations and their underlying mechanisms; (2) precision medicine, by personalizing treatment regimens based on molecular alterations, (3) interventive and preventive care, by identifying high-risk individuals for screening & other preventive strategies. However, I believe we need better conceptual approaches for understanding the genotype-to-phenotype map. As a result, my research spans both basic and more translational research areas.
