...
## Publication
* __Sun, Z.__, Oates, C. J. & Briol, F-X. (2023). Meta-learning Control Variates: Variance Reduction with Limited Data. Accepted for publication In Proceedings of the 39th Conference on Uncertainty in Artificial Intelligence (__UAI 2023__) [(selected for an oral presentation)]().
*   __Sun, Z.__, Barp, A., Briol, F.-X.(2023). Vector-valued Control Variates. Accepted for publication In Proceedings of the 40th International Conference on Machine Learning (__ICML 2023__).
