...
# Introduction
I am a machine learning engineer at [Realtor.com](www.https://www.realtor.com/) and former researcher focused on developing scalable models for both inference and prediction in geospatial settings with a focus on latent variable models and Bayesian methods. My educational background consists of degrees in [physics (BA, 2013)](https://www.macalester.edu/physics/), [statistics (MS, 2020)](https://stat.duke.edu/), and [civil engineering](http://borsuk.pratt.duke.edu/) (PhD, 2020). 

I have consulted in the past for firms using Bayesian methods in marketing analytics and have previously worked in the healthcare sector as a database engineer. I also worked as a part of the GeoAI research group at [Oak Ridge National Laboratory] I currently work on problems related to security and geospatial modeling.  I also have teaching experience as a university instructor for graduate-level classes in applied statistical modeling. You can find more additional information at the curriculum vitae linked on this webpage. 
