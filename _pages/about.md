...
Research
======
I am generally interested in designing efficient, generalizable and explanable learning algorithms with theoretical guarantee. Specifically, my current research topics include but not limited to: 1. Designing learning strategies for more advanced and human like AI, including multi task learning, continual learning, and domain generalization. 2. Developing optimization algorithms with better scalability and performance, such as distributed parallel training for Graph Neural Networks (GNNs) on large scale graphs and gradient free optimization via alternating direction method of multipliers (ADMM), etc.
