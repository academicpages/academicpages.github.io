...
I am Yusheng Su, a fourth-year Ph.D. at the [THUNLP Lab](https://twitter.com/tsinghuanlp), [Department of Computer Science and Technology](http://www.cs.tsinghua.edu.cn/), [Tsinghua University](https://www.tsinghua.edu.cn/publish/thu2018en/index.html). I am advised by Prof. Zhiyuan Liu.

<!--[Prof. Zhiyuan Liu](https://scholar.google.com/citations?user=dT0v5u0AAAAJ&hl=zh-TW).--> 
...
My research interests are exploring the mechanism (theory) and operation (practice) of <b>large-scale pre-trained models (LLMs)</b> for efficient and effective deployment in real-world applications. To achieve these goals, I focus on two potential directions:
