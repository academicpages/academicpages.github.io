...
My research spans the areas of natural language processing and machine learning. In particular, I aspire to develop general intelligent systems (pre-trained foundation models) that have human-like cognitive capacities (e.g., understanding, reasoning, etc) and efficiently adapt them to new tasks. To achieve these goals, I focus on the following directions:
