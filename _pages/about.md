...
+ [**Recommender Systems in the Era of Large Language Models (LLMs)**](https://arxiv.org/abs/2307.02046)
  ...
  <p style="margin-top: 5px;"><div class='paper-box-image'><div><div class="badge">ArXiv</div><img src='/images/LLMs_tasks.png' alt="sym" width="400"></div></p>
...
+ [**Empowering Molecule Discovery for Molecule-Caption Translation with Large Language Models: A ChatGPT Perspective**](https://arxiv.org/abs/2306.06615)
  ...
  <p style="margin-top: 5px;"><div class='paper-box-image'><div><div class="badge">ArXiv</div><img src='/images/MolReGPT.png' alt="sym" width="400"></div></p>
...
+ [**Generative Diffusion Models on Graphs: Methods and Applications**](https://arxiv.org/abs/2302.02591)
  ...
  <p style="margin-top: 5px;"><div class='paper-box-image'><div><div class="badge">IJCAI2023</div><img src='/images/survey.png' alt="sym" width="400"></div> </p>
...
+ [**Improving User Controlled Table-To-Text Generation Robustness**](https://arxiv.org/abs/2302.09820)
  ...
  <p style="margin-top: 5px;"><div class='paper-box-image'><div><div class="badge">EACL2023</div><img src='/images/outputs.png' alt="sym" width="400"></div> </p>
...
+ [**Late-Stage Photoredox C–H Amidation of N-Unprotected Indole Derivatives: Access to N-(Indol-2-yl)amides**](https://pubs.acs.org/doi/10.1021/acs.orglett.1c00609)
  ...
  <p style="margin-top: 5px;"><div class='paper-box-image'><div><div class="badge">Org. Lett.</div><img src='/images/2021ACS.png' alt="sym" width="400"></div> </p>
...
+ [**Selective Photoredox Trifluoromethylation of Tryptophan-Containing Peptides**](https://chemistry-europe.onlinelibrary.wiley.com/doi/abs/10.1002/ejoc.201901572)
  ...
  <p style="margin-top: 5px;"><div class='paper-box-image'><div><div class="badge">EurJOC</div><img src='/images/ejoc_3.jpg' alt="sym" width="400"></div> </p>
