...
I earned a B.S. and M.S. in Computer and Information Systems from [Florida Agricultural and Mechanical University](http://www.famu.edu) and a Ph.D. in Computer Science from the [University of Colorado at Boulder](http://www.colorado.edu). My research career has been focused on developing tools and techniques to support enterprise integration from both the data and process perspectives. I sometimes consult with organizations to help them develop strategies and tools to analyze their data and processes.
