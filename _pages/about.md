...
<sub><a name="fn1">1</a>: Note that gravity waves are not referring to the same phenomena as gravitational waves! Whereas the latter energetic events ripple the space-time continuum, the former can be found closer to our homes, and are driven by buoyancy. Waves propagating in the deep oceans of our mother Earth can for example be identified as gravity waves. [↩](#a1)</sub>
