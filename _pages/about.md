...
My research interests are exploring the mechanism (theory) and operation (practice) of <b>large-scale pre-trained models (LLMs)</b> for efficient and effective deployment in real-world applications. To achieve these goals, two potential directions that I focus on are:
