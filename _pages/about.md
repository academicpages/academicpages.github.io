...
I leverage machine learning and quantum simulation while performing experiments to explore new questions in the following directions:
  * List item one 
...
Developed an algorithm to extract virtual gates of a Double Quantum Dot stability diagram based on features extracted by the Python line segment detector (PyLsd).
